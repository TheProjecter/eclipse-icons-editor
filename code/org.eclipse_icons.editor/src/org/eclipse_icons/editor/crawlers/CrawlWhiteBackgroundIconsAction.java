...
public class CrawlWhiteBackgroundIconsAction extends Action {
	...
	public CrawlWhiteBackgroundIconsAction() {
		this.setImageDescriptor(Activator
				.getImageDescriptor("icons/crawlWhiteBackgroundIconsAction.png"));
	...
	public void run() {
		...
		if (result!=null){
			...
			// Open result
			if (paths.isEmpty()){
				MessageDialog.openInformation(Display.getCurrent().getActiveShell(), "Crawl WhiteBackground icons", "No potential WhiteBackground Icons found.");
			} else {
