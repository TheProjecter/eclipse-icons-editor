 ...
 */
public class IconsEditorImageTransfer extends ByteArrayTransfer {

	private static final String TYPENAME = "icons_editor_image_transfer";

	private static final int TYPEID = registerType(TYPENAME);

	private static IconsEditorImageTransfer _instance = new IconsEditorImageTransfer();

	public static IconsEditorImageTransfer getInstance() {
		return _instance;
	}
