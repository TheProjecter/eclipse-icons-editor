...
public class PixelItem implements Cloneable {
	...
	public Object clone() {
		...
		try {
			...
			// We need to take care of creating new Rectangle and Point, otherwise it will be the same objects
			if (pixelRectangle!=null){
				clonedPixelItem.pixelRectangle = new Rectangle(this.pixelRectangle.x, this.pixelRectangle.y, this.pixelRectangle.width, this.pixelRectangle.height);
			}
